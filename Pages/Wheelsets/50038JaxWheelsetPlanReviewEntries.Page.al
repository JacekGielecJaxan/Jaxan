page 50038 "Wheelset Plan Review Entries"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Wheelset Plan Review Entries';
    DataCaptionFields = "Wheelset No.";
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = List;
    Permissions = TableData "Wheelset Plan Review Entry" = m;
    SourceTable = "Wheelset Plan Review Entry";
        ...
        area(navigation)
        {
            group("Ent&ry")
            {
                ...
                action(Wheelset)
                {
                    ...
                    Caption = 'Wheelset';
                    Image = Customer;
                    RunObject = Page "Wheelset Card";
                    RunPageLink = "No." = field("Wheelset No.");
