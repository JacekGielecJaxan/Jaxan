page 50023 "Wagon Prorogation Entries"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Wagon Prorogation Entries';
    DataCaptionFields = "Wagon No.";
    Editable = false;
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = List;
    Permissions = TableData "Wagon Prorogation Entry" = m;
    SourceTable = "Wagon Prorogation Entry";
