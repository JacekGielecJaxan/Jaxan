page 50020 "Wagon Plan Review Entries"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Wagon Plan Review Entries';
    DataCaptionFields = "Wagon No.";
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = List;
    Permissions = TableData "Wagon Plan Review Entry" = m;
    SourceTable = "Wagon Plan Review Entry";
