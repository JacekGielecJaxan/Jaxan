page 50320 "Vehicle Plan Review Entries"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Vehicle Plan Review Entries';
    DataCaptionFields = "Vehicle No.";
    DeleteAllowed = false;
    InsertAllowed = false;
    PageType = List;
    Permissions = TableData "Vehicle Plan Review Entry" = m;
    SourceTable = "Vehicle Plan Review Entry";
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Review Group"; Rec."Review Group Code")
                {
                    ApplicationArea = basic, suite;
                    Editable = false;
                }
